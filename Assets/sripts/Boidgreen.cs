...
public class Boidgreen : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        pos = Random.insideUnitSphere * Spawnergreen.S.spawnRadius;

        //Set a random initial velocity
        Vector3 vel = Random.onUnitSphere * Spawnergreen.S.velocity;
        ...
        attPos = Xattractor.POS; //this is the attractor position
        //Boid positon is pos
    ...
    private void FixedUpdate()
    {
        ...
        Spawnergreen spn = Spawnergreen.S;
        ...
        Vector3 delta = Xattractor.POS - pos;
